...
**
******************************************************************************/
extern bt_vendor_interface_t * get_bt_vendor_interface();
...
void init_vnd_if(unsigned char *local_bdaddr)
{
    ...
    if (!dlhandle)
    {
		printf("\n !!! Failed to load libbt-vendor.so !!! \n");
    ...
    if (!bt_vnd_if)
    {
		printf("\n !!! Failed to get bt vendor interface !!! \n");
        ALOGE("!!! Failed to get bt vendor interface !!!");
        return;
    }
#endif
	//bt_vnd_if = (bt_vendor_interface_t *) get_bt_vendor_interface();
